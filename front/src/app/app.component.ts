...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, LoginComponent, RegisterFormComponent,InicioComponent, EventosComponent, PerfilComponent, OrganizadoresComponent, OrganizadoresinformacionComponent],
